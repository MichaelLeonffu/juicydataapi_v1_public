...
module.exports = {
	...
	OPR: function(eventData, query){
		...
		result.prediction = {
			...
			chance: orange.juice[query.alliance1.team1] + orange.juice[query.alliance1.team2] == orange.juice[query.alliance2.team1] + orange.juice[query.alliance2.team2]? 50 : orange.juice[query.alliance1.team1] + orange.juice[query.alliance1.team2] < orange.juice[query.alliance2.team1] + orange.juice[query.alliance2.team2]? ((juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) : ((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))),
			alliance1: {
