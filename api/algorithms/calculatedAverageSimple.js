...
module.exports = {
	...
	OPR: function(eventData, query){
		...
		//Predictions:
		result.prediction = {
			winner: juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2] == juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]? 'tie' : juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2] < juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]? 'alliance2' : 'alliance1',
			...
			//chance: ((((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])-(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))/(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2])) < 1? (((juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2])-(juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2]))/(juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])) : ((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) * 100,
			//chance: (((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) < 1? ((juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+)) : ((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) * 100,
			//chance: ((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) < 1? 
			chance: juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2] == juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]? 50 : juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2] < juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]? ((juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))) : ((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])/((juicyOPR.juice[query.alliance1.team1] + juicyOPR.juice[query.alliance1.team2])+(juicyOPR.juice[query.alliance2.team1] + juicyOPR.juice[query.alliance2.team2]))),
			alliance1: {
